      ...
      <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
          ...
          <li class="sub open">
            ...
            <ul class="templatemo-submenu">
              <li><a href="approve.php">อนุมัติกู้/สัญญากู้</a></li>
            ...
            <div class="row">
              <div class="col-md-100">
                <div class="table-responsive">
                  ...
                  <center><a href="approve.php"class="button button2"style="width:300px;height:50px">เพิ่มข้อมูลยื่นเสนอกู้/อนุมัติกู้</a></center>
                  </body>
<br>
                  <table class="table table-striped table-hover table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th>เลขที่เสนอกู้</th>
                        <th>วันทียื่นกู้</th>
                        <th>จำนวนเงินที่ยืนกู้</th>
                        <th>จำนวนเงินที่อนุมัติกู้</th>
                        <th>ดอกเบี้ย/ปี(%)</th>
                        <!-- <th>วัน/เดือน/ปี ที่เริ่มชำระ</th>
                        <th>วัน/เดือน/ปี ที่สิ้นสุดการชำระ</th>
                        <th>เลขที่ใบอนุมัติกู้</th>
                        <th>จำนวนเงินชำระ/งวด</th>
                        <th>จำนวนงวดที่ชำระ</th>
                        <th>ชื่อ-นามสกุลคู่สมรส</th>
                        <th>จำนวนดอกเบี้ย(กรณีผู้กู้ไม่ชำระเงินภายในกำหนด)</th>
                        <th>สถานะ</th> -->
                          <th>ดูเพิ่มเติม</th>
                        <th>แก้ไข</th>
                        <th>ลบ</th>
                    ...
                    <td><div align="center"><?php echo $result["account_approve"];?></div></div></td>
                    <td><div align="center"><?php echo $result["date"];?></div></td>
                    <td><div align="center"><?php echo $result["amount"];?></div></div></td>
                    <td><div align="center"><?php echo $result["amount_approve"];?></div></td>
                    <td><div align="center"><?php echo $result["interest"];?></div></div></td>
                    <td>
                      <a href="upapprove.php?a_id=<?php echo $result["a_id"];?>" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-user"></span>
                      </a></td>
                      <td>
                  <a href="editapprove.php?a_id=<?php echo $result["a_id"];?>" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-pencil"></span>
                  </a></td>
                  <td> <a href="JavaScript:if(confirm('ลบรายชื่อสมาชิกหรือไม่?')==true){window.location='deleteapprove.php?a_id=<?php echo $result['a_id'];?>';}" class="btn btn-sm btn-warning"><span class="glyphicon glyphicon-trash"></span>
                  </a></td>
                </tr>
                          <!-- Split button -->
                          <?php
