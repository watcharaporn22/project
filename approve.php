                  ...
                  <form role="form" class="lead" method="post" action="approve_insert.php">
                    ...
                    <div class="row">
                      <div class="col-md-2 margin-bottom-10">
                        ...
                        <input name="id" type="id" class="form-control" id="id" value="">
                      </div>
                      <div class="col-md-6 margin-bottom-15">
                        <label for="lastName" class="control-label"><font size="3">เลขที่เสนอกู้</font></label>
                        <input name="account_approve" type="text" class="form-control" id="account_approve" value="">
                      </div>
                     ...
                     <input name="date" type="date" class="form-control">
                      ...
                      <div class="col-md-4 margin-bottom-15">
                        ...
                        <input name="amount_approve"type="text" class="form-control" id="amount_approve" value="">
                      </div>
                      <div class="col-md-4 margin-bottom-15">
                        <label for="lastName" class="control-label"><font size="3">ดอกเบี้ย/ปี(%)</font></label>
                        <input name="interest"type="text" class="form-control" id="interest" value="">
                      </div>
                      <div class="col-md-6 margin-bottom-15">
                     ...
                     <input name="date2" type="date" class="form-control">
                      ...
                      <div class="col-md-6 margin-bottom-15">
                        ...
                        <input name="no_approve"  type="text" class="form-control" id="no_approve">
                      </div>
                      <div class="col-md-6 margin-bottom-15">
                      ...
                      <div class="col-md-6 margin-bottom-15">
                        ...
                        <input name="interest1" type="text" class="form-control" id="interest1">
                      </div>
                      <div class="col-md-6 margin-bottom-15">
