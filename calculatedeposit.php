            ...
            <div class="row">
              <div class="col-md-100">
                <ul class="nav nav-pills">
                  <br>
                    <h4 class="margin-bottom-15">คำนวณดอกเบี้ยเงินฝาก</h4>
                    <br>
                    <br>
                    <div class="row">
                      <div class="col-md-10">
                        ...
                        <form role="form" class="lead" method="post" action="payment_insert.php">
                          ...
                          <div class="row">
                            <div class="col-md-5 margin-bottom-10">
                              <label for="firstName" class="control-label"><font size="3">จำนวนเงินฝาก</font></label>
                              <input name="amount" type="text" class="form-control" id="amount" value="">
                            </div>
                            <div class="col-md-5 margin-bottom-10">
                              <label for="firstName" class="control-label"><font size="3">ดอกเบี้ย (%)</font></label>
                              <input name="interest" type="text" class="form-control" id="interest" value="">
                            </div>
                            <div class="col-md-5 margin-bottom-15">
                              <label for="dt"><font size="3">วัน/เดือน/ปีเริ่มฝาก</font></label>
                           <input name="date" type="date" class="form-control">
                            </div>
                            <div class="col-md-5 margin-bottom-15">
                              <label for="dt"><font size="3">วัน/เดือน/ปีครบกำหนดฝาก</font></label>
