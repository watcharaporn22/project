            ...
            <div class="row">
              <div class="col-md-100">
                <div class="table-responsive">
                  ...
                  <center><a href="adddata.php"class="button button2"style="width:200px;height:40px">เพิ่มข้อมูลเงินฝาก</a></center>
                  </body>
<br>
                  <table class="table table-striped table-hover table-bordered">
                    ...
                    <td><div align="center"><?php echo $result["numberno"];?></div></div></td>
                    <td><div align="center"><?php echo $result["date"];?></div></td>
                    <td><div align="center"><?php echo $result["numbercard"];?></div></div></td>
                    <td><div align="center"><?php echo $result["balance"];?></div></div></td>
                    <td>
                      <a href="deposit.php?id=<?php echo $result["id"];?>&numbercard=<?php echo $result["numbercard"];?>" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-plus"></span>
                      </a></td>
                      <td>
                        <a href="withdraw.php?id=<?php echo $result["id"];?>&numbercard=<?php echo $result["numbercard"];?>" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-minus"></span>
                        </a></td>
                        <td>
                        <a href="editaccount.php?id=<?php echo $result["id"];?>" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-pencil"></span>
                        </a></td>
				                <td> <a href="JavaScript:if(confirm('ลบรายชื่อสมาชิกหรือไม่?')==true){window.location='deleteadddata.php?id=<?php echo $result['id'];?>';}" class="btn btn-sm btn-warning"><span class="glyphicon glyphicon-trash"></span>
                        </a></td>
                      </tr>
                          <!-- Split button -->
                          <?php
