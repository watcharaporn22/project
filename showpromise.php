                ...
                <div class="table-responsive">
                  ...
                  <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                      ...
                      <td><div align="center"><?php echo $result["no_approve"];?></div></td>
                      <td><div align="center"><?php echo $result["amount"];?></div></div></td>
                      <td><div align="center"><?php echo $result["around"];?></div></td>
                      <td><div align="center"><?php echo $result["name"];?></div></div></td>
                      <td><div align="center"><?php echo $result["interest"];?></div></td>
                      <td>
                <a href="editpromise.php?p_id=<?php echo $result["p_id"];?>" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-pencil"></span>

                    </a></td>

				      <td> <a href="JavaScript:if(confirm('ลบรายชื่อสมาชิกหรือไม่?')==true){window.location='deletepromise.php?p_id=<?php echo $result['p_id'];?>';}" class="btn btn-sm btn-warning"><span class="glyphicon glyphicon-trash"></span>
